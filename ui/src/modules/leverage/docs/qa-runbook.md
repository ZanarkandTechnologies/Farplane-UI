...
2. Open Office → command palette → **Leverage**, the cash HUD, and the Finance Office room; each must open the same panel.
3. Confirm detailed Capital is read from Finance; no separate Finance panel or per-project cash value appears.
