...
export function SkillOsMiniApp(): ReactElement {
  ...
  const invocationState = useSkillInvocationCounts(
    activeOsTab === "skill-tree" || activeOsTab === "invocations",
  );
  ...
  return (
    ...
    >
      <TabsList className="mb-3 w-fit max-w-full flex-wrap justify-start">
        ...
        <TabsTrigger value="standards">Standards / Rollout</TabsTrigger>
      </TabsList>

      <TabsContent value="skill-tree" className="m-0 min-h-0 flex-1">
