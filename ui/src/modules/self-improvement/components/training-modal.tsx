              ...
              <div className="max-w-4xl mx-auto space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Choose how you want to improve your capabilities today.
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  >
                    <div className="p-6 space-y-3">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Acquire new capabilities through deep research and practice.
                      </p>
                    </div>
                  </Card>
                  <Card
                    className="hover:border-primary/50 cursor-pointer transition-all hover:shadow-md group"
                    onClick={() => toast.info("Deep Research module coming soon")}
                  >
                    <div className="p-6 space-y-3">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Refine existing knowledge with targeted study.
                      </p>
                    </div>
                  </Card>
                  <Card
                    className="hover:border-primary/50 cursor-pointer transition-all hover:shadow-md group border-primary/20 bg-primary/5"
                  ...
                  >
                    <div className="p-6 space-y-3">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Initialize a Layout 1 Arena to benchmark and optimize performance.
                      </p>
                    </div>
                  </Card>
                  <Card
                  ...
                  >
                    <div className="p-6 space-y-3">
                      <div className="p-3 bg-emerald-100 dark:bg-emerald-900/20 rounded-lg w-fit group-hover:scale-110 transition-transform">
                        <Microscope className="h-6 w-6 text-emerald-600 dark:text-emerald-400" />
                      </div>
                      <h3 className="font-semibold">Open Skill Studio</h3>
                      <p className="text-sm text-muted-foreground">
                        Browse skill files, inspect diagrams, and run saved demo cases.
                      </p>
                    </div>
                  </Card>
                </div>
