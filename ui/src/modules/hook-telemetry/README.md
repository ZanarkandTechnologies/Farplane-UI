...
- Thread create/fork hooks emit `thread.created` and `thread.forked` metadata for read-only lineage graphing. They do not store prompts, transcripts, or full thread bodies.
