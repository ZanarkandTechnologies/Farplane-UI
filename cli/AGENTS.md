...
- Owns the Farplane command-line entrypoints, install/bootstrap flows, and sidecar-facing operator commands.
...
- Treat `npm link` at the repo root as the canonical way to expose the global `farplane` alias.
