...
- Do not claim the global `farplane` alias from this repo. Farplane Core owns the global command and delegates UI/office/team module commands here through `npm run cli -- ...` or the module-local `farplane-ui` bin.
