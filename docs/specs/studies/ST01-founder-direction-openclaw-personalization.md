...
Farplane UI should become a personalized autonomous company cockpit:
...
- Let users continue working in external specialist tools (for example Notion/Vibe) while Farplane UI aggregates and orchestrates.
...
- External workflow tools should remain first-class; Farplane UI should not clone full Notion/Vibe UX.
...
- Maintain Farplane UI as unified read and orchestration layer.
