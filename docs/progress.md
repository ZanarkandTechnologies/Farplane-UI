...
- SC11 is now formalized in `docs/features/FEAT-0111-affiliate-marketing-mvp.md` and defines the canonical PM/executor affiliate loop plus concrete measure/execute/distribute skill contracts.
